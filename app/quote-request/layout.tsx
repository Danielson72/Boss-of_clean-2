...
export const metadata = generatePageMetadata({
  ...
  description: 'Request free quotes from local residential & commercial service pros in your Florida area. Compare prices, read reviews, and book the best pro for your needs.',
  path: '/quote-request',
