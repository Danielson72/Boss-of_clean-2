  ...
  const team = [
    {
      name: 'David Alvarez',
      role: 'Founder & CEO',
      email: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'info@bossofclean.com',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-blue-100">{process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'info@bossofclean.com'}</p>
            </div>
