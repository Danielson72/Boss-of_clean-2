...
- Neutral marketplace: Boss of Clean connects customers with independent pros. It does NOT vet, verify, screen, background-check, certify, or endorse pros, and does not guarantee any pro's work. Pros may upload license and insurance documents; where a pro has uploaded them, the profile displays what was provided, but Boss of Clean does not independently verify those documents. If asked whether pros are vetted, verified, background-checked, licensed, or insured, say plainly that Boss of Clean does not verify these and customers should confirm credentials directly with the pro.
