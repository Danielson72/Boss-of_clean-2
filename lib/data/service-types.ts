...
export const SERVICE_TYPES: ServiceType[] = [
  ...
  // Coverall carve-out (DLD-256): 'commercial-cleaning' entry removed
  // pending franchisor approval. DB enum value 'commercial' is retained
  // for rollback safety.
  {
    slug: 'deep-cleaning',
  ...
  },
  {
    ...
    description: 'Professional residential window cleaning for Florida homes. Crystal-clear windows inside and out.',
    longDescription: 'Florida sun, salt air, and seasonal pollen quickly cloud your windows. Our professional residential window cleaners deliver streak-free results for Florida homes, including two- and three-story houses. Services include interior and exterior window cleaning, screen cleaning, and track and sill cleaning. See Florida sunshine clearly through spotless windows.',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Yes, professional residential window cleaners have equipment for two- and three-story homes, including extension poles, ladders, and water-fed pole systems.'
      },
      {
  ...
  // Coverall carve-out (DLD-256): 'office-cleaning' entry removed
  // pending franchisor approval. DB enum value 'office_cleaning'
