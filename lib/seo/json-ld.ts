...
export function generateOrganizationSchema() {
  return {
    ...
    description: 'Florida\'s residential & commercial service marketplace. Connect with independent local pros across all 67 counties. Purrfection is our Standard.',
    url: BASE_URL,
    logo: {
      '@type': 'ImageObject',
...
export function generateWebsiteSchema() {
  return {
    ...
    name: 'Boss of Clean',
    url: BASE_URL,
    description: 'Florida\'s residential & commercial service marketplace. Connect with independent local pros across all 67 counties.',
    publisher: {
      '@id': `${BASE_URL}/#organization`,
    },
    potentialAction: {
