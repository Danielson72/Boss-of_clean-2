      ...
      <div className="p-6">
        ...
        <div className="flex gap-2">
          {instantBooking ? (
            <Link
              href={`/book/${id}`}
              className="flex-1 bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 transition duration-300 text-sm font-medium flex items-center justify-center gap-2"
            >
          ...
          <Link
            href={profileUrl}
            className="px-3 py-2 border border-gray-300 rounded-md hover:bg-gray-50 transition duration-300 text-sm font-medium"
          >
            View
          </Link>
        </div>
