...
// Format: { [key: string]: { label?: string; icon?: React.ComponentType; color?: string; theme?: { light: string; dark: string } } }
      ...
      dangerouslySetInnerHTML={{
        __html: colorConfig
          .map(
            ([key, itemConfig]) => `
[data-chart=${id}] {
  --color-${key}: ${itemConfig.color || itemConfig.theme?.light};
}
.dark [data-chart=${id}] {
  --color-${key}: ${itemConfig.color || itemConfig.theme?.dark};
}
`
          )
          .join("\n"),
